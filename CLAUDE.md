...
- `src/data/site.ts` — name, URL, phone, email, **NAP address** (Level 1/457-459 Elizabeth St, Surry Hills NSW 2010 — moved from Haymarket 28 Jul 2026), hours, social. `abn` is still `"TODO"`.
