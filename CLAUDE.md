...
- `node scripts/check-schema.mjs` — asserts stable JSON-LD `@id`s (`#organization`, `#website`, `#voco`, per-city `#service`) and byte-exact Haymarket NAP in the built HTML.
