...
- **AU phone stays on the AU side.** `+61 2 5504 1140` and the Haymarket NAP must not appear in email to international prospects — same Europe-truthful rule the `check-truthful` gate enforces on the global build (PLAN.md §8). There is no European premises and no European line; the CTA there is "book a pilot".
